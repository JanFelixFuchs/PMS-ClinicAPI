...
public class Room : IEntity, IDeletable, IArchivable
{
    ...
    private void ValidateAndSetRoomCategories(ICollection<RoomCategory> roomCategories)
    {
        ...
        InvariantValidationHelper.ConstructInvariantValidation(
            () => InvariantValidationConditions.IsContainingOnlyElementsBelongingToSameClinic(roomCategories, roomCategory => roomCategory.ClinicId, ClinicId, nameof(RoomCategories)),
